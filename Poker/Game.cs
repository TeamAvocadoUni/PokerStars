    ...
    public partial class Game : Form
    {
        ...
        async Task AllIn()
        {
            ...
            if (abc == 1)
            {
                ...
                {
                    bot1Chips += int.Parse(textBoxGamePot.Text);
                    playerChips.Text = bot1Chips.ToString();
                    b1Panel.Visible = true;
                ...
                {
                    bot2Chips += int.Parse(textBoxGamePot.Text);
                    playerChips.Text = bot2Chips.ToString();
                    b2Panel.Visible = true;
                ...
                {
                    bot3Chips += int.Parse(textBoxGamePot.Text);
                    playerChips.Text = bot3Chips.ToString();
                    b3Panel.Visible = true;
                ...
                {
                    bot4Chips += int.Parse(textBoxGamePot.Text);
                    playerChips.Text = bot4Chips.ToString();
                    b4Panel.Visible = true;
                ...
                {
                    bot5Chips += int.Parse(textBoxGamePot.Text);
                    playerChips.Text = bot5Chips.ToString();
                    b5Panel.Visible = true;
